...
urlpatterns = [
    ...
    # car
    path('carinfo/car?=<slug:brand>_<slug:model>_<slug:year>', get_car, name='get-car'),
    
    path('editcar/car?=<slug:brand>_<slug:model>_<slug:year>', get_car_info_for_edit, name='edit-car'), # manager only
    ...
    # brand
    path('brandinfo/brand?=<slug:name>', get_brand, name='get-brand'),
    
    path('editbrand/brand?=<slug:brand>', get_brand_info_for_edit, name='edit-brand'), # manager only
    ...
    # category
    path('category/category?=<slug:name>', category , name='category'),
    
    path('editcategory/category?=<slug:category>', get_category_info_for_edit, name='edit-category'), # manager only
    ...
    path('addtocart/car?=<slug:brand>_<slug:model>_<slug:year>', add_to_cart, name='add-to-cart'),
    
    path('editrequest', UpdateDeleteRequest.as_view(), name='edit-request'),
    
    # contract
    path('contractinfo/contract?=<slug:info_str>', get_contract, name='get-contract'),
    ...
    path('editcontract/contract?=<slug:info_str>', get_contract_info_for_edit, name='edit-contract'),
