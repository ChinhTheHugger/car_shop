...
class Request(models.Model): # similar to "cart"
    ...
    def get_or_create(car_name,customer_username):
        return Request.objects.get_or_create(customer=customer_username,car=car_name,quantity='1',date=date.today(),status='False')
